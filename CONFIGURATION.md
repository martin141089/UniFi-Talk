...
| `health_check_timeout_seconds` | `30` | Wie lange `sofia status gateway` nach einer scharfen Änderung auf einen gesunden `REGED`-Status abgefragt wird, bevor aufgegeben und zurückgerollt wird. |
